...
const Dashboard = () => {
  ...
  const [dcaskBalance, setDcaskBalance] = useState(0.0);
          ...
          <div>
            <div className="w-full flex items-center justify-between flex-wrap mb-6">
              ...
              <div className="flex items-center gap-5 flex-wrap">
                ...
                >
                  Deposit USDT{' '}
                  <MoneyRecive size="20" color="#484848" className="ml-1" />
                </button>
              </div>
            </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 py-3 w-full gap-5 ">
                <CardComponent>
                    ...
                    <div className="flex items-center justify-start flex-row gap-2">
                      ...
                      <div>
                        ...
                        >
                          ...
                          {user && user?.country_currency ? (
                            <option value={2}>{user?.country_currency}</option>
                          ) : (
                            ''
                          )}
                        </select>
                  ...
                  <div className="space-y-2">
                    <p className="text-[#C0C0C0] text-sm ">Total Balance</p>
                    <h3 className="text-3xl text-white">${usdcBalance}</h3>
                  </div>
                </CardComponent>
                ...
                <CardComponent>
                  ...
                  <div className="space-y-2">
                    <p className="text-[#C0C0C0] text-sm ">Total Balance</p>
                    <h3 className="text-3xl text-white">${dcaskBalance}</h3>
                  </div>
                </CardComponent>
                ...
                <CardComponent>
                  <div className="w-full flex items-start justify-between flex-col gap-1">
                    ...
                    <p className="inline-flex items-center text-sm">
                      ...
                      <span className="text-[#8BFFC9] text-xs">+ 2.0%</span>
                    </p>
                  </div>
