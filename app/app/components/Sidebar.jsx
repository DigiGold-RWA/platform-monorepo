...
const Sidebar = ({ business }) => {
    ...
    const wrapperClasses = classNames(
        "h-full sidebar pb-4 bg-white lg:flex justify-between shadow-sm scrollbar-change flex-col overflow-y-auto overflow-x-hidden border-r border-[#EDEFF3] hidden w-64"
    );
        ...
        <>
            ...
            >
                <div className="flex flex-col">
                    <div className="px-4">
                        <div className="flex items-center justify-center py-5 border-b  border-[#8D8E8E]  relative h-20 ">
