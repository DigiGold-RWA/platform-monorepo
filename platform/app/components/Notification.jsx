...
export default function Notification() {
  ...
  const updateKycUrl = async () => {
    ...
    if (user.shuftipro_url) {
      ...
      const response = await axios.post(`${hostUrl}/api/customer/initkyc`, {
          ...
          <div className=" flex items-center justify-start flex-1 gap-2">
            ...
            {user.kyc_status === 'pending' ? (
              <p className="text-white inline-flex">
                Your KYC is in progress. This notification will be removed once
              ...
              <p className="text-white inline-flex">
                Kindly complete the KYC verification in order to gain full
                access to the DigiGold platform
                <Link
                  href="#"
                  target="_blank"
