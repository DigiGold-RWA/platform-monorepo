                  ...
                  <div className="card gap-[2rem] p-[2rem] rounded-2xl  bg-card-background text-white">
                    <div className="flex items-start justify-start gap-3">
                      ...
                      <div className="space-y-2 flex-1">
                        ...
                        <div className='flex items-center justify-between gap-2 flex-wrap text-base text-[#FFCC29]'>
                          <p className="">Jan</p>
                          <p className="">Feb</p>
                          <p className="">Mar</p>
                          <p className="">Apr</p>
                  ...
                  <div className="card gap-[2rem] p-[2rem] rounded-2xl  bg-card-background text-white">
                    <div className="flex items-start justify-start gap-3">
                      ...
                      <div className="space-y-2 flex-1">
                        ...
                        <div className='flex items-center justify-between flex-wrap text-base text-[#FFCC29]'>
                          <p className="">Jan</p>
                          <p className="">Feb</p>
                          <p className="">Mar</p>
                          <p className="">Apr</p>
